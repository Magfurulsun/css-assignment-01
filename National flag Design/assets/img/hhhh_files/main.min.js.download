...
function(e) {
    ...
    function w() {
        ...
        100), _.get("inline")) {
            ...
            h(c)
        } else _.get("iframe") ? h(" ") : _.get("html") ? h(_.get("html")) : s(_, e) ? (e = l(_, e), q = _.get("createImg"), t(q).addClass(Z + "Photo").bind("error." + Z,
        function() {
        ...
        function() {
            d === le && setTimeout(function() {
                ...
                W[1] && (_.get("loop") || W[A + 1]) && (q.style.cursor = "pointer", t(q).bind("click." + Z,
                function() {
                    J.next()
                })),
    ...
    var v, x, y, b, T, C, H, k, W, E, I, M, L, F, R, S, K, P, B, O, _, j, D, N, z, A, q, U, $, G, Q, J, V, X = {
        ...
        createImg: function() {
            ...
            return "object" == typeof i && t.each(i,
            function(t, i) {
                e[t] = i
            }),
            e
        ...
        createIframe: function() {
            ...
            return "object" == typeof n && t.each(n,
            function(t, e) {
                i[t] = e
            }),
    ...
    ce = function() {
        ...
        function n() {
            ...
            S.html(_.get("slideshowStart")).unbind(s).one(s,
            function() {
                J.next(),
                i()
            }),
    ...
    J.prep = function(i) {
        ...
        if (U) {
            ...
            d = function() {
                ...
                F.html(_.get("title")).show(), I.show(), a > 1 ? ("string" == typeof _.get("current") && R.html(_.get("current").replace("{current}", A + 1).replace("{total}", a)).show(), K[_.get("loop") || a - 1 > A ? "show": "hide"]().html(_.get("next")), P[_.get("loop") || A ? "show": "hide"]().html(_.get("previous")), ce(), _.get("preloading") && t.each([h( - 1), h(1)],
                function() {
                    var i, n = W[this],
                    ...
                    src: _.get("href"),
                    "class": Z + "Iframe"
                }).one("load", o).appendTo(I), ae.one(he,
                function() {
                    n.src = "//about:blank"
                }), _.get("fastIframe") && t(n).trigger("load")) : o(), "fade" === _.get("transition") ? x.fadeTo(g, 1, i) : i())
            },
            "fade" === _.get("transition") ? x.fadeTo(g, 0,
            function() {
                J.position(0, d)
            }) : J.position(g, d)
        }
    },
    J.next = function() { ! $ && W[1] && (_.get("loop") || W[A + 1]) && (A = h(1), f(W[A]))
    },
    J.prev = function() { ! $ && W[1] && (_.get("loop") || A) && (A = h( - 1), f(W[A]))
    },
    J.close = function() {
        U && !G && (G = !0, U = !1, u(oe), _.get("onCleanup"), E.unbind("." + Z), v.fadeTo(_.get("fadeOut") || 0, 0), x.stop().fadeTo(_.get("fadeOut") || 0, 0,
        function() {
            x.hide(),
            v.hide(),
            u(he),
...
function(e) {
    ...
    "99px" === e(a).css("lineHeight") && n.push("lineHeight"),
    a.style.lineHeight = "",
    e.fn.autosize = function(i) {
        return this.length ? (i = e.extend({},
        o, i || {}), a.parentNode !== document.body && e(document.body).append(a), this.each(function() {
            function o() {
                var t, o = window.getComputedStyle ? window.getComputedStyle(u, null) : !1;
                o ? (t = u.getBoundingClientRect().width, (0 === t || "number" != typeof t) && (t = parseFloat(o.width)), e.each(["paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth"],
                function(e, i) {
                    t -= parseFloat(o[i])
                })) : t = p.width(),
                a.style.width = Math.max(t, 0) + "px"
            }
            function s() {
                var s = {};
                if (t = u, a.className = i.className, a.id = i.id, d = parseFloat(p.css("maxHeight")), e.each(n,
                function(e, t) {
                    s[t] = p.css(t)
            ...
            function r() {
                var e, n;
                t !== u ? s() : o(),
                a.value = !u.value && i.placeholder ? p.attr("placeholder") || "": u.value,
                a.value += i.append || "",
                a.style.overflowY = u.style.overflowY,
                n = parseFloat(u.style.height),
                a.scrollTop = 0,
                a.scrollTop = 9e4,
                e = a.scrollTop,
                d && e > d ? (u.style.overflowY = "scroll", e = d) : (u.style.overflowY = "hidden", c > e && (e = c)),
                e += w,
                n !== e && (u.style.height = e + "px", a.className = a.className, f && i.callback.call(u, u), p.trigger("autosize.resized"))
            }
            function l() {
                clearTimeout(h),
        ...
        return "string" == typeof t ? (this.each(function() {
            ...
            function t(e) {
                ...
                if (s.cache[t] = e, e.length && t.length >= o.minChars) {
                    for (var a = "",
                    c = 0; c < e.length; c++) a += o.renderItem(e[c], t);
                    s.sc.html(a),
                    s.updateSC(0)
                } else s.sc.hide()
            }
            ...
            s.sc.appendTo("body"),
            s.sc.on("mouseleave", ".autocomplete-suggestion",
            function() {
                e(".autocomplete-suggestion.selected").removeClass("selected")
            }),
            s.sc.on("mouseenter", ".autocomplete-suggestion",
            function() {
                e(".autocomplete-suggestion.selected").removeClass("selected"),
                e(this).addClass("selected")
            }),
            s.sc.on("mousedown", ".autocomplete-suggestion",
            function(t) {
                var a = e(this),
                c = a.data("val");
                return (c || a.hasClass("autocomplete-suggestion")) && (s.val(c), o.onSelect(t, c, a), s.sc.hide()),
                !1
            }),
            s.on("blur.autocomplete",
            function() {
                try {
            ...
            o.minChars || s.on("focus.autocomplete",
            function() {
                s.last_val = "\n",
                s.trigger("keyup.autocomplete")
            }),
            s.on("keydown.autocomplete",
            function(t) {
                if ((40 == t.which || 38 == t.which) && s.sc.html()) {
                    var a, c = e(".autocomplete-suggestion.selected", s.sc);
                    return c.length ? (a = 40 == t.which ? c.next(".autocomplete-suggestion") : c.prev(".autocomplete-suggestion"), a.length ? (c.removeClass("selected"), s.val(a.addClass("selected").data("val"))) : (c.removeClass("selected"), s.val(s.last_val), a = 0)) : (a = 40 == t.which ? e(".autocomplete-suggestion", s.sc).first() : e(".autocomplete-suggestion", s.sc).last(), s.val(a.addClass("selected").data("val"))),
                    s.updateSC(0, a),
                    !1
                }
...
function(t) {
    function e(t, a, r, n) {
        ...
        for (f || (f = t.width() - 2), i = 0; i < a.length; i++) if (w.push(a[i]), c += a[i][2] + r.margin, c >= f) {
            ...
            for (s = (f - m) / (c - m), u = Math.ceil(r.rowHeight * s), exact_w = 0, l, g = 0; g < w.length; g++) l = Math.ceil(w[g][2] * s),
            exact_w += l + r.margin,
            exact_w > f && (l -= exact_w - f),
            o();
            w = [],
            c = 0,
            d++
        }
        for (g = 0; g < w.length; g++) l = Math.floor(w[g][2] * s),
        h = Math.floor(r.rowHeight * s),
        o(!0);
    ...
    t.fn.flexImages = function(a) {
        ...
        return this.each(function() {
            ...
            e(a, n, i),
            t(window).off("resize.flexImages" + a.data("flex-t")),
            t(window).on("resize.flexImages" + o,
            function() {
                e(a, n, i)
            }),
            a.data("flex-t", o)
...
function(t) {
    t.fn.unveil = function(i) {
        ...
        function() {
            ...
            t && this.setAttribute("src", t),
            i && this.setAttribute("srcset", i)
        }),
        r.on("scroll.unveil resize.unveil lookup.unveil", e),
        e(),
        this
    }
} (window.jQuery);
...
function setCookie(k, v, d, s) {
    var o = new Date;
    o.setTime(o.getTime() + 864e5 * d + 1000 * (s || 0)),
    document.cookie = k + "=" + v + ";path=/;expires=" + o.toGMTString()
}
...
if ('ontouchstart' in window) {
    ...
    $('.pure-dropdown>a').click(function(e) {
        ...
        if (pure_menu.offset().left + sub.outerWidth() > ww && ww > sub.outerWidth()) sub.css('left', pure_menu.width() - sub.outerWidth());
        else sub.css('left', 0);
        return false;
    });
...
$('.mm_inc').each(function() {
    ...
    if ($(this).hasClass('mm_sep')) mm.append('<li class="pure-menu-separator"></li>');
});
$('.mum_inc').each(function() {
    mum.append($(this).clone().removeClass('hide-xs hide-sm hide-md'));
});
 
$(document).on('submit', '.ajax_form',
function(e) {
    e.preventDefault();
    var form = $(this),
    ...
    form.ajaxSubmit({
        ...
        error: function(re) {
            form.find('[type="submit"]').removeAttr('disabled');
            $('#loadingBar').css('width', '102%').addClass('error').fadeOut(2000,
            function() {
...
$(window).resize(function() {
    ...
    resizeTimer = setTimeout(resized, 200);
});
$(document).on({
...
'#colorbox h6');
$(document).on('click contextmenu', '.modal',
function() {
 
    return false;
});
$(document).on('click', '.ajax',
function() {
    var link = $(this);
...
$(document).on('click dblclick', '.remove_link',
function(e) {
...
$(document).on('click', '[data-location]',
function(e) {
    location = $(this).data('location');
});
$(document).on('click', '.home-tag-list li',
function(e) {
    $(this).siblings().removeClass('selected').end().addClass('selected');
    return false;
});
$(document).on('click', '.tiny_search label',
function(e) {
    var input = $(this).next(),
    form = $(this).closest('form');
    if (!form.hasClass('active')) form.addClass('active');
    else {
        if (input.hasClass('dirty')) form.submit();
        else form.removeClass('active');
    }
});
$(document).on('click', 'a[data-confirm]:not(.ajax, .modal, .remove_link)',
function(e) {
    if (!confirm($(this).data('confirm') || I18N['delete'])) return false;
});



var sf_btn, max_zindex = 99999;
$(document).on('click', '.sf_btn',
function() {
    max_zindex += 1;
    var button = $(this);
    sf_btn = button.next();
    if (sf_btn.is(':visible')) {
        sf_btn.hide();
        sf_btn = false;
    } else {
        $('.sf_btn+div').hide();
        ...
        if (button.data('left') || (button.offset().left + sf_btn.outerWidth() > ww && button.offset().left + button.outerWidth() - sf_btn.outerWidth() > 0)) l += button.outerWidth() - sf_btn.outerWidth();
        if (button.data('up') || (button.offset().top + button.outerHeight() + sf_btn.outerHeight() > $(document).scrollTop() + wh && button.offset().top - sf_btn.outerHeight() > 0)) var t = button.position().top - sf_btn.outerHeight() - 5;
        else var t = button.position().top + button.outerHeight() + 5;
        sf_btn.unbind().css({
            position: 'absolute',
            top: t + 'px',
            left: l + 'px',
...
$(document).click(function(e) {
    if (sf_btn && !sf_btn.is(e.target) && !sf_btn.has(e.target).length) {
        sf_btn.hide();
        sf_btn = false;
    }
});
...
$(document).ready(function(){
		...
		$(this).find('label.select-option').click(function(){
			$(this).parent().css('display','none');
			//$(this).siblings('label.select-option').removeClass("active");
			//$(this).addClass("active");
			$(this).parent().prev('span.sf_btn').find("b").html($(this).attr('value'));
			
			$(this).parent().find('i').remove();
			$(this).children('b').after("<i class='check'>✓</i>")
						
			var url = $(location).attr('href');
			console.log($('.clear_f').length);
			if(!$('.clear_f').length) $("span.tone-group+div").after("<span class='clear_f'><a href='"+url+"'>Clear filters</a></span>");
		});

		$(this).find('label.color-item').click(function(){
			$(this).parent().parent().css('display','none');
			$(this).parent().parent().prev('span.sf_btn').find("b").html($(this).attr('value'));
...
(PrevNextReplace)();
window.onresize = PrevNextReplace; // will be executed at resize
function PrevNextReplace() {
...
$(function() {
    ...
    $(window).scroll(function() {
        if ($(this).scrollTop() > 480) $('#toTop').addClass('show');
    ...
    } else if ($('.signup_form.new').length)
    ...
    if ($('#content-box').length) {
        ...
        $('.dwn-btn tr:not(.no_default)').last().click();
    }
